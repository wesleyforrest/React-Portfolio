    ...
    <div className="about">
      ...
      <div className="media-query">
        ...
        <p className="about-section__about-text">
          ...
          stack developer. A proactive and conscientious individual with
          ...
          improvement through the effective use of technology. With proven
          Project and IT implementation management experience of projects
